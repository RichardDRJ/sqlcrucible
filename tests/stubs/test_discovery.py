...
def test_get_entities_finds_all_entities():
...
def test_get_entities_includes_abstract():
    entities = get_entities_from_module("tests.stubs.sample_models")
    assert StubTestBase in entities
    assert RelationshipBase in entities
    assert StubAbstractParent in entities
