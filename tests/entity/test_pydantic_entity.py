...
def test_model_dump_then_validate_preserves_all_fields():
...
def test_model_dump_json_then_validate_json_preserves_all_fields():
...
def test_model_json_schema_contains_declared_fields():
...
def test_model_json_schema_omits_readonly_descriptor_fields():
